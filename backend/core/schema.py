...
class Query(uauth.schema.Query, categories.schema.Query, challenges.schema.Query, teams.schema.Query, index.schema.Query,
server.schema.Query, graphene.ObjectType):
    pass
